...
DefinitionBlock ("TPM2Dev.dat", "SSDT", 1, "MSFT", "NTCTPM", 1)
{
    Scope (\_SB)
    {
        Device(TPM1)
        {
            ...
            Name(_CID, "MSFT0101")
            Name(_UID, 1)
            Name(_DDN, "Nuvoton TPM 2.0 Device")            // _DDN: DOS Device Name
            Name(_STR, Unicode ("Nuvoton TPM 2.0 Device"))  // _STR: Description String
            Name (RBUF, ResourceTemplate ()
            {
// MinnowBoardMax 100Khz
                I2cSerialBus (0x57, ControllerInitiated, 100000, AddressingMode7Bit, "\\_SB.I2C6", 0x00, ResourceConsumer, ,)
// RaspberryPi2 100KHz
//              I2cSerialBus (0x57, ControllerInitiated, 100000, AddressingMode7Bit, "\\_SB.I2C1", 0x00, ResourceConsumer, ,)
            })
