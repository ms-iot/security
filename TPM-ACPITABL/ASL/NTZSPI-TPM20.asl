...
DefinitionBlock ("TPM2Dev.dat", "SSDT", 1, "MSFT", "NTZSPI", 1)
{
    Scope (\_SB)
    {
        Device(TPM1)
...
// RaspberryPi2 5MHz, SPI0/CS0
//                SpiSerialBus (0x0000, PolarityLow, FourWireMode, 0x08, ControllerInitiated, 0x004C4B40, ClockPolarityLow, ClockPhaseFirst, "\\_SB.SPI0", 0x00, ResourceConsumer, ,)
// RaspberryPi2 5MHz, SPI0/CS1
//                SpiSerialBus (0x0001, PolarityLow, FourWireMode, 0x08, ControllerInitiated, 0x004C4B40, ClockPolarityLow, ClockPhaseFirst, "\\_SB.SPI0", 0x00, ResourceConsumer, ,)
// RaspberryPi2 5MHz, SPI1/CS0 (DeviceSelection on SPI1/CS0 is mapped to 0x0001 not 0x0000!)
//                SpiSerialBus (0x0001, PolarityLow, FourWireMode, 0x08, ControllerInitiated, 0x004C4B40, ClockPolarityLow, ClockPhaseFirst, "\\_SB.SPI1", 0x00, ResourceConsumer, ,)
            })
