...
RazorClamPersistentDataType persistedData = {
    RAZORCLAMPERSISTEDDATA,
    RAZORCLAMPERSISTEDVERSION,
    sizeof(RazorClamPersistentDataType),
#ifdef STMTPM
    {0x0022, {0x00, 0x0b, 0xed, 0x30, 0x2f, 0xce, 0x9a, 0xa0, 0x93, 0x5f, 0xc6, 0xca, 0x20, 0x6c, 0x91, 0x17, 0x0f, 0x24, 0x40, 0xca, 0x9d, 0x3b, 0x57, 0xbd, 0x5b, 0x19, 0xb9, 0x2a, 0x12, 0xc4, 0x35, 0x68, 0x14, 0x2a}}, // EkName
    {0x0022, {0x00, 0x0b, 0x76, 0x0e, 0x62, 0x4e, 0xa9, 0xe8, 0xc2, 0x1a, 0xe5, 0xb4, 0xc5, 0x81, 0x89, 0x6d, 0xd4, 0xd7, 0x83, 0x13, 0xdd, 0x74, 0x32, 0x88, 0x44, 0x5f, 0xe8, 0x37, 0x39, 0x80, 0x5e, 0xa2, 0x03, 0x14}}, // PlatformAuthority#endif
#endif
#ifdef IFXTPM
    {0x0022, {0x00, 0x0b, 0xf1, 0x7e, 0x19, 0x23, 0xcb, 0xe7, 0xca, 0xea, 0x4c, 0x81, 0x16, 0x78, 0x5b, 0x30, 0x32, 0x9f, 0xb1, 0x58, 0xb3, 0x97, 0x11, 0x09, 0x60, 0xca, 0x78, 0x95, 0x12, 0x1d, 0x9e, 0x9b, 0x34, 0x30}}, // EkName
    {0x0022, {0x00, 0x0b, 0xe8, 0xa9, 0xcb, 0xe4, 0x3d, 0x0b, 0xb9, 0xad, 0x84, 0xa6, 0xfe, 0x55, 0x80, 0x37, 0xde, 0x52, 0xe1, 0x82, 0x1e, 0xef, 0x32, 0x9b, 0xbc, 0x2b, 0xe3, 0x28, 0x2a, 0x3a, 0xdd, 0xc6, 0xc3, 0xc0}}, // PlatformAuthority
#endif
#ifdef NTZTPM
    {0x0022, {0x00, 0x0b, 0xe1, 0x59, 0x02, 0x2a, 0xb2, 0x3e, 0x74, 0x3c, 0x7f, 0x4e, 0x2c, 0x72, 0x1a, 0xd8, 0x9a, 0xbf, 0xf8, 0x59, 0xd9, 0xc2, 0x42, 0xdf, 0x9b, 0xc0, 0xaf, 0xdd, 0xe9, 0x05, 0x1d, 0x68, 0x13, 0x7b}}, // EkName
    {0x0022, {0x00, 0x0b, 0xbb, 0x0f, 0xc3, 0xf2, 0xdf, 0x79, 0x8d, 0x1c, 0x60, 0x2f, 0x2e, 0x63, 0x19, 0x55, 0x25, 0x28, 0xd3, 0x38, 0xba, 0xfb, 0xe1, 0x16, 0x73, 0x60, 0xd7, 0xd4, 0x04, 0x39, 0xe9, 0xfc, 0xd9, 0x4f}}, // PlatformAuthority
//    {0x0022, {0x00, 0x0b, 0x16, 0x5f, 0x88, 0xce, 0xc9, 0x86, 0x0f, 0x38, 0x13, 0x60, 0x0c, 0xcd, 0x03, 0x12, 0x33, 0x0b, 0x2c, 0xb3, 0xb8, 0xaa, 0xc3, 0x62, 0x19, 0x3e, 0xe3, 0xe6, 0x59, 0xba, 0xbe, 0x0f, 0xb6, 0xde}}, // EkName
//    {0x0022, {0x00, 0x0b, 0xc4, 0xd9, 0x94, 0xb7, 0x66, 0xdd, 0x6b, 0x10, 0x47, 0xae, 0x22, 0xa2, 0xb1, 0x66, 0xc5, 0x48, 0xce, 0x60, 0xd1, 0xc7, 0x0d, 0x7f, 0xbc, 0xcc, 0x51, 0x21, 0x90, 0xd3, 0xb8, 0x79, 0x1b, 0xf3}}, // PlatformAuthority
#endif
    {0x0020, {0xCB, 0x8F, 0x0D, 0x1C, 0xFA, 0xCB, 0x1D, 0x50, 0xF1, 0xEF, 0x79, 0x67, 0x97, 0xBA, 0x2A, 0x44, 0xA5, 0x9A, 0x45, 0x0D, 0xF2, 0x72, 0x30, 0x04, 0x40, 0x1B, 0x27, 0x87, 0x5D, 0x8E, 0xB9, 0x03}},             // LockoutAuth: sha256("Lockout")
    {0x0020, {0x01, 0x25, 0x59, 0xF0, 0xF0, 0xC4, 0xF8, 0xE7, 0xB4, 0x0D, 0xFA, 0x58, 0x4D, 0x1E, 0xAF, 0x6F, 0x7C, 0xE2, 0xD6, 0xFD, 0xEE, 0x9D, 0xC3, 0x06, 0x55, 0x54, 0xAB, 0x65, 0xC8, 0x02, 0x63, 0xC4}},             // EndorsementAuth: sha256("Endorsement")
    {0x0020, {0x5D, 0x90, 0x0D, 0x03, 0x60, 0xB2, 0x31, 0x84, 0xF9, 0x19, 0x61, 0xF8, 0x92, 0x02, 0x75, 0x3D, 0x8B, 0x2B, 0x8A, 0x1B, 0x65, 0xAD, 0x65, 0x93, 0x4E, 0x6B, 0x72, 0x5C, 0xC1, 0x60, 0xE8, 0x74}}              // OwnerAuth: sha256("Storage")
};

//// Default Policy Test
//uint8_t fakeAppPayload[48] = {
...
#ifdef NTZTPM
// Fake signed application payload:
// The quick brown fox jumps over the lazy dog
// 'TPM2AUTH'
// TPM2B_PUBLIC: SM2 Key
// TPMT_SIGNATURE: SM2 signature over SM3 digest
uint8_t fakeAppPayload[213] = {

};
//uint8_t fakeAppPayload[213] = {
//0x54, 0x68, 0x65, 0x20, 0x71, 0x75, 0x69, 0x63, 0x6b, 0x20, 0x62, 0x72, 0x6f, 0x77, 0x6e, 0x20,
//0x66, 0x6f, 0x78, 0x20, 0x6a, 0x75, 0x6d, 0x70, 0x73, 0x20, 0x6f, 0x76, 0x65, 0x72, 0x20, 0x74,
//0x68, 0x65, 0x20, 0x6c, 0x61, 0x7a, 0x79, 0x20, 0x64, 0x6f, 0x67, 0x54, 0x50, 0x4d, 0x32, 0x41,
//0x55, 0x54, 0x48, 0x00, 0x58, 0x00, 0x23, 0x00, 0x0b, 0x00, 0x04, 0x04, 0x60, 0x00, 0x00, 0x00,
//0x10, 0x00, 0x1b, 0x00, 0x12, 0x00, 0x20, 0x00, 0x10, 0x00, 0x20, 0x34, 0x95, 0xed, 0xbc, 0x17,
//0x6a, 0xde, 0x09, 0x87, 0xc1, 0xd9, 0x7c, 0x72, 0xeb, 0x88, 0x15, 0xb2, 0x9d, 0xca, 0xef, 0x29,
//0x64, 0xf2, 0xf8, 0xbc, 0x0d, 0x93, 0xf1, 0xf2, 0x01, 0x2a, 0x4e, 0x00, 0x20, 0x9d, 0xc8, 0x09,
//0x6f, 0x2d, 0x20, 0xe0, 0xa6, 0x75, 0x81, 0xb0, 0x04, 0xb1, 0x91, 0x77, 0x6e, 0xf0, 0xf6, 0xee,
//0x3a, 0x36, 0x07, 0x90, 0x21, 0xa3, 0x9a, 0x13, 0x18, 0xec, 0x95, 0xf8, 0x56, 0x00, 0x1b, 0x00,
//0x12, 0x00, 0x20, 0xea, 0x01, 0xcd, 0xcd, 0x18, 0x79, 0xdc, 0x4b, 0x8d, 0xf6, 0x49, 0x8a, 0xa1,
//0xda, 0x2a, 0xae, 0x17, 0xc3, 0xa5, 0xe3, 0xc5, 0x62, 0x26, 0x9b, 0xed, 0xf6, 0xde, 0xd2, 0xd4,
//0x8b, 0x2c, 0xd7, 0x00, 0x20, 0xfc, 0xa7, 0x7a, 0x3e, 0x17, 0x15, 0xc6, 0x5d, 0x7b, 0xd1, 0xf7,
//0x69, 0x21, 0x20, 0xb9, 0x3c, 0x07, 0xcf, 0xcb, 0x91, 0x36, 0xc5, 0xe2, 0x56, 0x35, 0x8e, 0x45,
//0x85, 0xde, 0x91, 0xa3, 0x84
//};
#endif
...

};
#endif
...

};
#endif
...
)
{
    ...
    if((appPayloadSigntureBlock = FindSignatureBlock(fakeAppPayload, sizeof(fakeAppPayload))) > 0)
    {
...
//        PrintBuffer("APP", fakeAppPayload, appPayloadSigntureBlock);
        ...
        if((retVal = VerifyCodeSignature(&fakeAppPayload[appPayloadSigntureBlock + sizeof(uint64_t)], sizeof(fakeAppPayload) - appPayloadSigntureBlock - sizeof(uint64_t), &volatileData.measurementLog[volatileData.measurementIndex - 1].measurement, &payloadAuthorityName)) != TPM_RC_SUCCESS)
        {
